...
public class CheckinDetails extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CheckinDetails frame = new CheckinDetails();
	 ...
	 * @throws SQLException 
	 */
	public CheckinDetails() throws SQLException {
		...
		contentPane.add(lblUpdateCheckStatus);
                ...
                ImageIcon i1  = new ImageIcon("hotelmanagementsystem\\src\\main\\resources\\images\\room-interior-hotel-bedroom.jpg");
				Image i2 =i1.getImage().getScaledInstance(500, 500, Image.SCALE_DEFAULT);
				ImageIcon i3 = new ImageIcon(i2);
                JLabel l1 = new JLabel(i3);
                l1.setBounds(450,70,476,320);
                add(l1);

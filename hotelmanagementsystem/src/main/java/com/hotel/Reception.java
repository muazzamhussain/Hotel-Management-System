...
public class Reception extends JFrame {
	...
	public Reception(){
		...
		contentPane.setLayout(null);
                ...
                ImageIcon i1  = new ImageIcon("hotelmanagementsystem\\src\\main\\resources\\images\\reception.jpg");
                Image i3 = i1.getImage().getScaledInstance(600, 500,Image.SCALE_DEFAULT);
                ImageIcon i2 = new ImageIcon(i3);
                JLabel l1 = new JLabel(i2);
                l1.setBounds(250,30,600,470);
                add(l1);
		...
		btnNewButton_5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
				CheckinDetails update = new CheckinDetails();

...
public class CheckOut extends JFrame{
	...
	public CheckOut() throws SQLException {
		...
		contentPane.setLayout(null);
                ...
                ImageIcon i1  = new ImageIcon("hotelmanagementsystem\\src\\main\\resources\\images\\checkin.jpg");
		...
		contentPane.add(c1);
                ...
                ImageIcon i4 = new ImageIcon("hotelmanagementsystem\\src\\main\\resources\\images\\search.png");
                Image i5 = i4.getImage().getScaledInstance(20, 20,Image.SCALE_DEFAULT);
                ImageIcon i6 = new ImageIcon(i5);
                JButton l2 = new JButton(i6);
                l2.setBounds(290,80,34,25);
                add(l2);

...
public class NewCustomer extends JFrame {
	...
	public NewCustomer() throws SQLException {
		...
		contentPane.setLayout(null);
                ...
                ImageIcon i1  = new ImageIcon("hotelmanagementsystem\\src\\main\\resources\\images\\side-view-woman-with-car.jpg");
                Image i3 = i1.getImage().getScaledInstance(400, 400,Image.SCALE_DEFAULT);
                ImageIcon i2 = new ImageIcon(i3);
                JLabel l1 = new JLabel(i2);
                l1.setBounds(480,10,400,500);
                add(l1);
		...
		contentPane.add(lblId);
                ...
                comboBox = new JComboBox<String>(new String[] {"Passport", "National Id", "Driving license"});
		...
		JLabel lblReserveRoomNumber = new JLabel("Allocate Room Number :");
		...
		JLabel lblCheckInStatus = new JLabel("Checked-In Status :");

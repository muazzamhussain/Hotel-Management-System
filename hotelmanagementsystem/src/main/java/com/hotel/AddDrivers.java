...
public class AddDrivers extends JFrame implements ActionListener{
	...
	contentPane.setLayout(null);
        ...
        ImageIcon i1  = new ImageIcon("hotelmanagementsystem\\src\\main\\resources\\images\\adddriver.jpg");
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(ae.getSource() == b1){
                ...
                String str = "INSERT INTO driver values( '"+name+"', '"+age+"', '"+gender+"','"+company+"', '"+brand+"', '"+available+"','"+location+"','"+contact+"')";
